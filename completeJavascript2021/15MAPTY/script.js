...
class App {
    ...
    _newWorkout(e){
        ...
        const duration = +inputDuration.value; //+ sign converts strings to numbers
        ...
        this._setLocalStorage();
         ...
         _renderWorkoutMarker(workout) 
         {
            ...
            .setPopupContent(`${workout.type === 'running' ? '🏃‍♂️': '🚴‍♀️'} ${this.#workout.description}`)
            .openPopup();   
    }
    ...
    _moveToPopup(e) {
        ...
        // workout.click(); // objects coming from string will lose some properties
    }
